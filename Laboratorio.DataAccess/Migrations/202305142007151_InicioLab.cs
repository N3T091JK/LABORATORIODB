namespace Laboratorio.DataAccess.Migrations
{
    ...
    public partial class InicioLab : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        NumCelular = c.String(nullable: false, maxLength: 15),
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.States", t => t.EstadoId, cascadeDelete: true)
                .Index(t => t.EstadoId);
                ...
                c => new
                    {
                        ...
                        CodProducto = c.String(nullable: false),
                ...
                c => new
                    {
                        ...
                        NomProducto = c.String(nullable: false, maxLength: 50),
                        EstadoId = c.Int(nullable: false),
                    })
                ...
                c => new
                    {
                        ...
                        States_EstadoId = c.Int(nullable: false),
                        UserTypes_TipoUsuarioId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.RolUsuarioId)
                .ForeignKey("dbo.States", t => t.States_EstadoId)
                .ForeignKey("dbo.UserTypes", t => t.UserTypes_TipoUsuarioId)
                .Index(t => t.States_EstadoId)
                .Index(t => t.UserTypes_TipoUsuarioId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.UserRoles", "UserTypes_TipoUsuarioId", "dbo.UserTypes");
            ...
            DropForeignKey("dbo.UserRoles", "States_EstadoId", "dbo.States");
            ...
            DropIndex("dbo.UserRoles", new[] { "UserTypes_TipoUsuarioId" });
            DropIndex("dbo.UserRoles", new[] { "States_EstadoId" });
