    ...
    public partial class inicio : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        NomEstado = c.String(nullable: false, maxLength: 30),
                    })
                ...
                c => new
                    {
                        ...
                        NombreExamen = c.String(nullable: false, maxLength: 50),
                        Precio = c.Decimal(nullable: false, precision: 18, scale: 2),
                        TipoDeExamenId = c.Int(nullable: false),
                        EstadoId = c.Int(nullable: false),
                    })
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Patients", t => t.PacienteId)
                .ForeignKey("dbo.Promotions", t => t.PromocionId)
                .Index(t => t.PacienteId)
                .Index(t => t.ExamenId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.InvoiceDetails", "PromocionId", "dbo.Promotions");
            ...
            DropIndex("dbo.InvoiceDetails", new[] { "PromocionId" });
